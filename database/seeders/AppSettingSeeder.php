...
class AppSettingSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            ['opportunity.expire_on_new_scan', 'true', 'boolean', 'scanner', true, 'Expire Opportunities On New Scan', 'Expire unexecuted watchlist candidates and pending trade plans from older scan runs when a new scan starts.'],
            ...
            ['monitor.active_trade_refresh_seconds', '15', 'integer', 'monitor', true, 'Active Trade Refresh Seconds', 'Continuous active simulated trade monitor interval for TP, SL, and trailing checks. Simulated trades do not expire by time or scan cycle.'],
            ...
            ['trade_plan.default_valid_hours', '6', 'integer', 'trade_plan', true, 'Default Trade Plan Valid Hours', 'Fallback safety validity. Primary expiry happens when a newer successful scan replaces old opportunities.'],
