...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('simulated_trades', function (Blueprint $table): void {
            ...
            $table->string('coindcx_symbol', 32)->index(); $table->string('entry_strategy', 32)->index(); $table->string('status', 32)->default('pending')->index();
            ...
            $table->decimal('exit_price',30,12)->nullable(); $table->string('exit_reason', 64)->nullable(); $table->text('notes')->nullable(); $table->json('raw_payload')->nullable(); $table->timestamps();
        });
