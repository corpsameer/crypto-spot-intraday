...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('scanner_metrics', function (Blueprint $table): void {
            ...
            $table->decimal('relative_strength_vs_btc', 12, 4)->nullable(); $table->string('btc_context')->nullable(); $table->string('eth_context')->nullable(); $table->string('market_condition', 32)->nullable();
            $table->decimal('overextension_risk', 12, 4)->nullable(); $table->decimal('risk_penalty', 12, 4)->nullable(); $table->decimal('final_score', 12, 4)->nullable()->index(); $table->string('score_label', 32)->nullable();
