...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('missed_gainers', function (Blueprint $table): void {
            $table->id(); $table->foreignId('spot_symbol_id')->constrained('spot_symbols')->cascadeOnDelete(); $table->string('coindcx_symbol', 32)->index(); $table->timestamp('detected_at')->index();
