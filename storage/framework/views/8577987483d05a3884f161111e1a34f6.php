...
<head>
    ...
    <title><?php echo e(config('app.name', 'Crypto Spot Intraday')); ?></title>
    <style>
...
<body>
    <nav class="navbar">
        <a class="brand" href="<?php echo e(route('cryptospot.dashboard')); ?>">Crypto Spot Intraday</a>
        <div class="nav-right">
            <a class="nav-link" href="<?php echo e(route('cryptospot.dashboard')); ?>">Dashboard</a>
            <a class="nav-link" href="<?php echo e(route('cryptospot.spot-symbols.index')); ?>">Spot Symbols</a>
            <a class="nav-link" href="<?php echo e(route('cryptospot.scans.latest')); ?>">Market Scanner</a>
            <a class="nav-link" href="<?php echo e(route('cryptospot.watchlist.index')); ?>">Watchlist</a>
            <a class="nav-link" href="<?php echo e(route('cryptospot.trade-plans.index')); ?>">Trade Plans</a>
            <a class="nav-link" href="<?php echo e(route('cryptospot.simulated-trades.index')); ?>">Simulated Trades</a>
            <a class="nav-link" href="<?php echo e(route('cryptospot.portfolio.index')); ?>">Portfolio</a>
            <a class="nav-link" href="<?php echo e(route('cryptospot.daily-review.index')); ?>">Daily Review</a>
            <a class="nav-link" href="<?php echo e(route('cryptospot.daily-gainers.index')); ?>">Daily Gainers</a>
            <a class="nav-link" href="<?php echo e(route('cryptospot.missed-gainers.index')); ?>">Missed Gainers</a>
            <a class="nav-link" href="<?php echo e(route('cryptospot.analytics.scanner-performance')); ?>">Scanner Analytics</a>
            <a class="nav-link" href="<?php echo e(route('cryptospot.analytics.trade-performance')); ?>">Trade Analytics</a>
            <a class="nav-link" href="<?php echo e(route('cryptospot.analytics.score-buckets')); ?>">Score Buckets</a>
            <a class="nav-link" href="<?php echo e(route('cryptospot.analytics.setup-types')); ?>">Setup Types</a>
            <a class="nav-link" href="<?php echo e(route('cryptospot.system-health.index')); ?>">System Health</a>
            <a class="nav-link" href="<?php echo e(route('cryptospot.settings.index')); ?>">Settings</a>
            <span><?php echo e(auth()->user()->email); ?></span>
            <form method="POST" action="<?php echo e(route('cryptospot.logout')); ?>">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Personal\projects\crypto-spot-intraday\resources\views/layouts/app.blade.php ENDPATH**/ ?>