...
try:
    ...
    from cryptospot.portfolio_release_manager import PortfolioReleaseManager  # noqa: E402
...
def _build_monitors(args: argparse.Namespace) -> list[tuple[str, object]]:
    ...
    if not args.skip_portfolio_release:
        monitors.append(("portfolio_release_manager", PortfolioReleaseManager()))
    return monitors
...
def main() -> int:
    ...
    parser.add_argument("--skip-portfolio-release", action="store_true", help="Skip portfolio capital release reconciliation")
